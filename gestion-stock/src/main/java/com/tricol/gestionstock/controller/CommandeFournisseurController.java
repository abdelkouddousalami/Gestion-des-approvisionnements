...
public class CommandeFournisseurController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('VIEW_COMMANDE')")
    ...
    @PreAuthorize("hasAuthority('RECEIVE_COMMANDE')")
    ...
    @PreAuthorize("hasAuthority('CANCEL_COMMANDE')")
    ...
    @PreAuthorize("hasAuthority('VALIDATE_COMMANDE')")
